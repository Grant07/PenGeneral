          ...
          <div class="row show-grid">
            ...
            <div class="col-md-12 mb-3">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body" onclick="link('cus');">
            ...
            <div class="col-md-12 mb-3">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body" onclick="link('sup');">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-0">
          ...
          <div class="col-md-3">
            ...
            <div class="col-md-12 mb-3">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body" onclick="link('emp');">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-0">
            ...
            <div class="col-md-12 mb-3">
              <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body" onclick="link('acc');">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-0">
          ...
          <div class="col-md-3">
            ...
            <div class="col-md-12 mb-3">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body" onclick="link('pro');">
                  <div class="row no-gutters align-items-center">
                        ...
                        <div class="panel-body">
                            <div class="list-group">
                              <?php 
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ?>
                                    <a href='pro_searchfrm.php?action=edit%20&%20id=<?php echo "$row[1]";?>' class='list-group-item text-gray-800'>
